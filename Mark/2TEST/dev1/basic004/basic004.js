...
// MUST
// NEED TO CHANGE control002 TO CURRENT FORM NAME
// FOR THIS CASE, basic001
// var BPMPROD = new DataSource("control002","BPMPROD");//BPM正式
// var T100TEST = new DataSource("control002","T100TEST");//T100测试
// var T100PROD = new DataSource("control002","T100PROD");//T100正式
// var BPMTEST = new DataSource("control002","BPMTEST");//BPM测试

var CURRENT_FORM_NAME="basic002"; // NOTE
var BPMPROD = new DataSource(CURRENT_FORM_NAME,"BPMPROD");//BPM正式
var T100TEST = new DataSource(CURRENT_FORM_NAME,"T100TEST");//T100测试
var T100PROD = new DataSource(CURRENT_FORM_NAME,"T100PROD");//T100正式
var BPMTEST = new DataSource(CURRENT_FORM_NAME,"BPMTEST");//BPM测试
...
txt09= "SELECT 检验项目,说明,状态  FROM BASIC009 ORDER BY 检验项目";
txt09x= "检验项目,说明,状态";
txt09y= "检验项目,说明,状态";
txt09z= "检验项目,说明,状态";
...
txt999="select ecaa001,ecaa002  from ecaa_t where ecaaent=11  ORDER BY ecaa001";
txt999x="ecaa001,ecaa002";
txt999y="ecaa001,ecaa002";
txt999z="ecaa001,ecaa002";

txt998="select 主件料号,主件品名,元件料号,元件品名,作业编号,作业名称 from BASIC998 ORDER BY 主件品名,作业编号";
txt998x="主件料号,主件品名,元件料号,元件品名,作业编号,作业名称";
txt998y="主件料号,主件品名,元件料号,元件品名,作业编号,作业名称";
txt998z="主件料号,主件品名,元件料号,元件品名,作业编号,作业名称";

// SELECT 工艺料号,品名,项次,作业编号,作业说明,工作站,工作站说明 from basic997
// SELECT 工艺料号,品名,项次,作业编号,作业说明,工作站,工作站说明 from basic997

txt997="select 工艺料号,品名,项次,作业编号,作业说明,工作站,工作站说明 from basic997 ORDER BY 工艺料号,作业编号";
txt997x="工艺料号,品名,项次,作业编号,作业说明,工作站,工作站说明";
txt997y="工艺料号,品名,项次,作业编号,作业说明,工作站,工作站说明";
txt997z="工艺料号,品名,项次,作业编号,作业说明,工作站,工作站说明";

// 997
function txt997a_onclick(){
	mark003(dsT100Prod, txt997, txt997x, txt997y, txt997z);
}
function txt997b_onclick(){
	mark003(dsT100Test, txt997, txt997x, txt997y, txt997z);
}
...
// 999
function txt999a_onclick(){
	mark003(dsT100Prod, txt999, txt999x, txt999y, txt999z);
}
function txt999b_onclick(){
	mark003(dsT100Test, txt999, txt999x, txt999y, txt999z);
}

// 998
function txt998a_onclick(){
	mark003(dsT100Prod, txt998, txt998x, txt998y, txt998z);
}
function txt998b_onclick(){
	mark003(dsT100Test, txt998, txt998x, txt998y, txt998z);
}
...
function initDebug(){
	...
	document.getElementById("txt999a").value = "999a";
	document.getElementById("txt999b").value =  "999b";
	
	document.getElementById("txt998a").value = "998a";
	document.getElementById("txt998b").value =  "998b";
	
	document.getElementById("txt997a").value = "997a";
	document.getElementById("txt997b").value =  "997b";
	
	document.getElementById("txt996a").value = "996a";
	document.getElementById("txt996b").value =  "996b";
...
function initCnt(){
	...
	initTxt("select COUNT(ecaa001) CNT  from ecaa_t  where ecaaent=11  ", "txt999a", "txt999b");
	initTxt("SELECT COUNT(*) CNT FROM BASIC998 ", "txt998a", "txt998b");
	
	initTxt("SELECT COUNT(*) CNT FROM BASIC997 ", "txt997a", "txt997b");
	initTxt("select COUNT(oocql002) CNT from OOCQL_T where oocql001=221 and OOCQLENT=11", "txt996a", "txt996b");
...
function BTdc_onclick(){
	...
	alert("...開發中,敬請期待! 已有功能,要先加上權限管制再開放!")
	return true;


//2017-04-14 16:12, by Mark
// 加開頁面後,用戶可以全選複製到Excel
var opened = window.open("");
opened.document.write("<html><head><title>MyTitle</title></head>");
opened.document.write("<style>");

opened.document.write("table { border-collapse:collapse; width:100%;  text-align:center;}");

opened.document.write("</style>");
opened.document.write("<body>");

// opened.document.write("XXXtest中文");
		var gridData = Grid1Obj.getData();
	// opened.document.write(gridData);
	opened.document.write("<table border='1'>");


	for (var row =0;row<gridData.length;row++){

		opened.document.write("<tr>");
		for (var col =0;col<gridData[row].length;col++){
					opened.document.write("<td>");
				opened.document.write(gridData[row][col]);
				opened.document.write("</td>");
		}
		opened.document.write("</tr>");	
...
opened.document.write("</table>");
			

		// //alert("2")
	 //       	for(var j =0;j<gridData.length;j++){
		// 			 //alert("3");
	 //       	    	if(gridData[j][1] == exceldata[j][1]){
		// 					 //alert("4");
		// 					msg = msg+ "料件号重复\n";
		// 				//alert(msg);
	 //       	    	   	}
